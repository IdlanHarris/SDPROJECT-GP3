...
$query = "SELECT user_id, username, email, phone_number, membership FROM users WHERE user_type = 'member' ORDER BY user_id ASC";
...
<div class="container">
  ...
  <div class="mt-2"><a href="staffDashboard.php#section3"><button type="submit" class="btn btn-primary">↩</button></a></div>
...
$(document).on('click', '.remove-btn', function() {
    ...
    if (confirm('Are you sure you want to remove this member?')) {
        ...
        $.ajax({
            type: 'POST',
            url: 'manageMember-staff.php', // The server-side script that handles the member removal
